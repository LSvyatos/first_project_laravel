<template>
  <v-toolbar app color="blue darken-3">
    <v-toolbar-side-icon @click="(event)=>this.$emit('sidebarMenu',event)"></v-toolbar-side-icon>
    <v-toolbar-title>Адмінка</v-toolbar-title>
    <v-spacer></v-spacer>
    ...
    <v-menu offset-y origin="center center" :nudge-bottom="10" transition="scale-transition">
      ...
      <v-list class="pa-0">
        <v-list-tile @click="logout" ripple="ripple" rel="noopener">
          ...
          <v-list-tile-content>
            <v-list-tile-title>Вийти</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
      </v-list>
    </v-menu>
